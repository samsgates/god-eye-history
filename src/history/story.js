...
import { update, setDate } from '../core/state.js';
import { toast } from '../core/utils.js';

export class StoryDirector{
  constructor(globe, history){this.globe=globe;this.history=history;this.timer=null;this.index=0;this.story=null}
  ...
  async playScene(index){
    ...
    if(s.date){setDate(s.date);document.getElementById('dateInput').value=s.date}
